...
<section id="wisata" class="container mx-auto py-10 relative overflow-hidden">
  <div class="px-4 py-10 grid lg:grid-cols-6 gap-5">
    <div class="lg:col-span-2 text-center lg:text-left mb-10 lg:mb-0">
      ...
      <a href="/wisata/" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-16 py-5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Lihat Semua</a>
    </div>
...
<section id="crowdfunding" class="container mx-auto py-10 relative overflow-hidden">
    <div class="px-4 py-10 grid lg:grid-cols-6 gap-5">
      <!-- Slider main container -->
      <div class="grid lg:grid-cols-3 grid-cols-1 gap-5 lg:col-span-4">
      ...
      <div class="lg:col-span-2 text-center lg:text-left mb-10 lg:mb-0">
        <h1 class="font-light text-3xl lg:text-6xl mb-5">Crowdfunding</h1>
        <p class="mb-10">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolores temporibus, et molestias sint aliquam tempora cum delectus nobis, tenetur repudiandae praesentium. Obcaecati hic asperiores vero laborum facere sint. Iusto, recusandae?</p>
        <a href="/pengembangan/" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-16 py-5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Lihat Semua</a>
      </div>
    </div>
  </section>
            ...
            <div class="swiper-slide">
              ...
              >
                <div>
                  ...
                  <div class="mt-4">
                    <p class="text-2xl font-bold text-blue-800 sm:text-3xl">
                      Stayin' Alive
                    </p>
