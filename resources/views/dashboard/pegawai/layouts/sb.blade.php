<div class="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto border-r">
  ...
  <div>
    ...
    <aside id="cta-button-sidebar"
        class="fixed lg:static h-screen lg:h-full top-0 left-0 transition-transform -translate-x-full lg:translate-x-0 z-40 w-64"
        aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-slate-600 lg:rounded-r-3xl dark:bg-gray-800">
            <div class="border-b-2">
                <div class="flex my-3">
                    <div class="relative me-5 w-10 h-10 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
                    ...
                    <div>
                        <h1 class="font-medium text-white">{{ Auth::user()->firstname }} {{ Auth::user()->lastname }}</h1>
            ...
            <ul class="space-y-2 font-medium my-5">
                <li>
                    <a href="purchases/list"
                        class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700">
                ...
                <li>
                  <a href="#"
                      ...
                      <span class="ml-3">Pencatatan Kinerja</span>
                  </a>
              </li>
              <li>
                  <a href="#"
                      ...
                      <span class="ml-3">Pengawasan</span>
                  </a>
              </li>
              <li>
                  <a href="#"
